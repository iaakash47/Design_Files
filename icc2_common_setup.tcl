...
set LIBRARY_SUFFIX		"saed32" ;# Suffix for the design library name ; default is unspecified   
set DESIGN_LIBRARY 		"${DESIGN_NAME}${LIBRARY_SUFFIX}" ;# Name of the design library; default is ${DESIGN_NAME}${LIBRARY_SUFFIX}
set REFERENCE_LIBRARY 		[list /home/aakash/physical_design_28nm/physical_design_flow/icc2_workshop_collaterals/saed32nm_hvt_1p9m.lef /home/aakash/physical_design_28nm/physical_design_flow/icc2_workshop_collaterals/avsddac.lef /home/aakash/physical_design_28nm/physical_design_flow/icc2_workshop_collaterals/avsdpll.lef]	;# Required; a list of reference libraries for the design library.
...
#set VERILOG_NETLIST_FILES      "/home/aakash/physical_design_28nm/physical_design_flow/icc2_workshop_collaterals/vsdbabysoc_gtlvl.v"
set VERILOG_NETLIST_FILES	"/home/aakash/physical_design_28nm/physical_design_flow/icc2_workshop_collaterals/vsdbabysoc_gtlvl.v"	;# Verilog netlist files;
					;# 	for DP: required
...
set TECH_FILE 			"/home/aakash/physical_design_28nm/physical_design_flow/icc2_workshop_collaterals/saed32nm_1p9m_mw.tf" 	;# A technology file; TECH_FILE and TECH_LIB are mutually exclusive ways to specify technology information; 
					;# TECH_FILE is recommended, although TECH_LIB is also supported in ICC2 RM. 
set TECH_LIB			"/home/aakash/physical_design_28nm/physical_design_flow/icc2_workshop_collaterals/saed32hvt_tt0p85v25c.lib"	;# Specify the reference library to be used as a dedicated technology library;
...
set ROUTING_LAYER_DIRECTION_OFFSET_LIST "{metal1 horizontal} {metal2 vertical} {metal3 horizontal} {metal4 vertical} {metal5 horizontal} {metal6 vertical} {metal7 horizontal} {metal8 vertical} {metal9 horizontal}" 
...
set MAX_ROUTING_LAYER		"metal9"	;# Max routing layer name; normally should be specified; otherwise tool can use all metal layers
...
set LINK_LIBRARY		[list /home/aakash/physical_design_28nm/physical_design_flow/icc2_workshop_collaterals/saed32hvt_tt0p85v25c.db /home/aakash/physical_design_28nm/physical_design_flow/icc2_workshop_collaterals/avsdpll.db /home/aakash/physical_design_28nm/physical_design_flow/icc2_workshop_collaterals/avsddac.db]	;# Specify .db files;
...
set RELEASE_DIR_DP		"write_data_dir_hier" 	;# Specify the release directory of DP RM; 
					...
					;#	for DP: not used 
set RELEASE_LABEL_NAME_DP 	"vsdbabysoc_saed32nm"	
